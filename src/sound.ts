// Web Audio API synthesized cyberpunk sound effects
let audioCtx: AudioContext | null = null;
let isMuted = typeof window !== 'undefined' ? localStorage.getItem('cyberpunk_sfx_muted') === 'true' : false;
...
export function toggleSoundMute(): boolean {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('cyberpunk_sfx_muted', String(isMuted));
  }
  return isMuted;
}
